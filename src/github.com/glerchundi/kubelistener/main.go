...
func AddConfigFlags(fs *flag.FlagSet, c *kubelistener.Config) {
	fs.StringVar(&c.KubeCfgFile, "kubecfg-file", c.KubeCfgFile, "Location of kubecfg file for access to kubernetes master service; --kube-master-url overrides the URL part of this; if neither this nor --kube-master-url are provided, defaults to service account tokens.")
